                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        >
                                            <Link
                                                ...
                                                "
                                                class="flex mr-5 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"
                                            >
                                                編集
                                            </Link>
                                            ...
                                            <button
                                                ...
                                                class="flex ml-5 text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg"
                                            >
                                                削除
                                            </button>
                                        </div>
